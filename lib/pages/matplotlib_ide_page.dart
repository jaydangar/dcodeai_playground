...
class MatplotlibIDEPage extends StatefulWidget {
  @override
  _MatplotlibIDEPageState createState() => _MatplotlibIDEPageState();
}

class _MatplotlibIDEPageState extends State<MatplotlibIDEPage> {
  ...
  Future<void> runPythonScript(String code) async {
    ...
    final result =
        await _channel.invokeMethod("runPythonMatplotlibScript", data);
                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      CodeSnippetWidget(
                        code: ConstUtils.matplotlib_pre,
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: TextFormField(
