...
class NLTKIDEPage extends StatefulWidget {
  @override
  _NLTKIDEPageState createState() => _NLTKIDEPageState();
}

class _NLTKIDEPageState extends State<NLTKIDEPage> {
  ...
  Future<void> runPythonScript(String code) async {
    ...
    final result = await _channel.invokeMethod("runPythonNLTKScript", data);
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: FlatButton(
                            ...
                            onPressed: () => appendAndRunPythonCode(context)),
                      ),
                    ),
                  ],
                ),
  ...
  void appendAndRunPythonCode(BuildContext context) async {
